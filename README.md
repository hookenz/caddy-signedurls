...
```bash
xcaddy build --with github.com/yourusername/caddy-signed-url
```

Or add it to your `go.mod`:

```bash
go get github.com/yourusername/caddy-signed-url
```
...
- 📖 [Documentation](https://github.com/yourusername/caddy-signed-url)
- 🐛 [Issue Tracker](https://github.com/yourusername/caddy-signed-url/issues)
